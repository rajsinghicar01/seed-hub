    ...
    <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
            ...
            <div class="carousel-container">
                <h2>Planting seeds of impact, one idea at a time.</h2>
                <p>Discover a vibrant space for growth, innovation, and transformation. Join our community and watch
                    your vision take root.</p>
            </div>
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-container">
                <h2>Where great minds meet to create.</h2>
                <p>Explore our dynamic coworking environment designed to inspire collaboration and productivity.
                    Flexible plans for teams of all sizes.</p>
            </div>
        </div><!-- End Carousel Item -->
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-container">
                <h2>Learning together, growing stronger.</h2>
                <p>Attend thought-provoking workshops, networking events, and seminars tailored to empower you and your
                    ventures.</p>
            </div>
        </div><!-- End Carousel Item -->
    ...
    <div class="container">
        <div class="row gy-4 justify-content-between align-items-center">
            ...
            <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                <h2 class="content-title mb-4">About Mustard Seed Hub</h2>
                <p class="mb-4">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        ...
                        <div class="service-item-content">
                            <h3 class="service-heading">Seed Sale</h3>
                            <p>
                                Gravida sodales condimentum pellen tesq accumsan orci quam
                                sagittis sapie
                            </p>
