...
@section('sub_headeing', 'Cropping season List')
...
<div class="card-header">
    ...
    <div class="float-right">
        <a class="btn btn-outline-primary btn-block btn-sm" href="{{ route('seasons.create') }}"><i
                class="fa fa-plus"></i> Create New Cropping Season</a>
    </div>
    @endcan
</div>
<div class="card-body">
